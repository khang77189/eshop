...
<section class="hero-slider">
	<!-- Single Slider -->
	<div class="single-slider" style=" background-image: url('admin/upload/background.jpg');">
		<div class="container">
					...
					<div class="text-inner">
						<div class="row">
							<div class="col-lg-7 col-12">
								<div class="hero-text">
									<h1><span style="font-size: 30px; color:aliceblue">Giảm giá lên tới 50%</span>FreeShip</h1>
									<div class="button">
										<a href="shop-grid.php" class="btn">Mua sắm ngay!!</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="single-product">
							...
							<div class="product-content">
								...
								<div class="product-price">
									<h3 style="color : black"><?php echo $row_product['price'] ?>VND</h3>
								</div>
							</div>
						</div>
					<?php } ?>
