        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                <div class="quickview-content">
                    ...
                    <h3><?php echo $row_product['price'] ?>VND</h3>
        ...
        ?>
                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="form-group">
                                        <label>Bình luận của bạnt<span>*</span></label>
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        ...
                                        <button name="submit" onclick="addCmt(<?php echo $row_product['id'] ?>)" type="submit" class="btn">Đăng bình luận</button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="col-12">
                <div class="comments" id="load">
                    <h3 class="comment-title">Các bình luận</h3>
                    <!-- Single Comment -->
                    <br>
                    <?php
